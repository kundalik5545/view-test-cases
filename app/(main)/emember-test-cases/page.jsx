...
const fetchStats = async () => {
  const res = await fetch("/api/test-cases/emember/stats", {
    cache: "no-store",
  });
...
export default function EmemberTestCases() {
  ...
  const portalChartData = useMemo(() => {
    return Object.entries(portal)
      .filter(([k]) => k && k !== "NotSet")
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="flex items-start gap-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-extrabold">eMember TC Dashboard</h1>
          ...
          <div className="ml-auto flex items-center gap-3">
            <Button asChild variant="ghost" className="text-sm">
              <Link href="/emember-test-cases/view">View Test Cases</Link>
            </Button>
          </div>
        </div>
        ...
        {!loading && stats && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <Card className="shadow-sm border">
                <CardHeader className="p-4">
                  <CardTitle className="text-lg">Portals (Bar)</CardTitle>
                </CardHeader>
                <CardContent className="p-4">
                  <div style={{ width: "100%", height: 260 }}>
                    <ResponsiveContainer>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">
                              {p.value} test(s) •{" "}
                              {portal[p.name]?.percentage
                                ? `${Number(portal[p.name].percentage).toFixed(
                                    1
                                  )}%`
                                : "—"}
                            </div>
